...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class AgentMovementNetworkObject : NetworkObject
	{
		...
		public InterpolateVector2 positionInterpolation = new InterpolateVector2() { LerpT = 0.4f, Enabled = true };
		...
		public AgentMovementNetworkObject() : base() { Initialize(); }
		public AgentMovementNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public AgentMovementNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
