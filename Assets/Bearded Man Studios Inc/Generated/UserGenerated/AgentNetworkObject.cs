...
{
	[GeneratedInterpol("{\"inter\":[0.5,0.5,0]")]
	public partial class AgentNetworkObject : NetworkObject
	{
		...
		public AgentNetworkObject() : base() { Initialize(); }
		public AgentNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public AgentNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
